...
import LeadChangesContext from '../../LeadChangesContext/LeadChangesContext'

// TODO: Move to l10n
const useLeadChangesFilters = (): LeadChangesFiltersState => {
    ...
    const [isShowMobile, setIsShowMobile] = useState(leadChangesFiltersInitialState.isShowMobile)
...
export default useLeadChangesFilters
