...
import StockConsumptionChangesContext from '../../StockConsumptionChangesContext/StockConsumptionChangesContext'

// TODO: Move to l10n
const useStockConsumptionChangesFilters = (): StockConsumptionChangesFiltersState => {
    ...
    const [isShowMobile, setIsShowMobile] = useState(stockConsumptionChangesFiltersInitialState.isShowMobile)
...
export default useStockConsumptionChangesFilters
