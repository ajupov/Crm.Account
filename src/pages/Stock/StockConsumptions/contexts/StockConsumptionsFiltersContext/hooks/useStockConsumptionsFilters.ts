...
import StockConsumptionsContext from '../../StockConsumptionsContext/StockConsumptionsContext'
import { getStockConsumptionTypesAsSelectOptions } from '../../../helpers/stockConsumptionTypeHelper'
import { toBooleanNullable } from '../../../../../../utils/boolean/booleanUtils'

// TODO: Move to l10n
const useStockConsumptionsFilters = (): StockConsumptionsFiltersState => {
    ...
    const [isApplyEnabled, setIsApplyEnabled] = useState(stockConsumptionsFiltersInitialState.isApplyEnabled)
    const [isResetEnabled, setIsResetEnabled] = useState(stockConsumptionsFiltersInitialState.isResetEnabled)
    const [isShowMobile, setIsShowMobile] = useState(stockConsumptionsFiltersInitialState.isShowMobile)

    const onChangeTypes = useCallback((_: any, data: DropdownProps) => {
        setTypes(data.value as StockConsumptionType[])
...
export default useStockConsumptionsFilters
