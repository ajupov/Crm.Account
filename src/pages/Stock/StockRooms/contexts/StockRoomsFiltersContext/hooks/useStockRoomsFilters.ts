...
import StockRoomsContext from '../../StockRoomsContext/StockRoomsContext'
import { toBooleanNullable } from '../../../../../../utils/boolean/booleanUtils'

// TODO: Move to l10n
const useStockRoomsFilters = (): StockRoomsFiltersState => {
    ...
    const [isApplyEnabled, setIsApplyEnabled] = useState(stockRoomsFiltersInitialState.isApplyEnabled)
    const [isResetEnabled, setIsResetEnabled] = useState(stockRoomsFiltersInitialState.isResetEnabled)
    const [isShowMobile, setIsShowMobile] = useState(stockRoomsFiltersInitialState.isShowMobile)
...
export default useStockRoomsFilters
