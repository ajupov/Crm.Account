...
import StockArrivalChangesContext from '../../StockArrivalChangesContext/StockArrivalChangesContext'

// TODO: Move to l10n
const useStockArrivalChangesFilters = (): StockArrivalChangesFiltersState => {
    ...
    const [isShowMobile, setIsShowMobile] = useState(stockArrivalChangesFiltersInitialState.isShowMobile)
...
export default useStockArrivalChangesFilters
