...
import StockBalanceChangesContext from '../../StockBalanceChangesContext/StockBalanceChangesContext'

// TODO: Move to l10n
const useStockBalanceChangesFilters = (): StockBalanceChangesFiltersState => {
    ...
    const [isShowMobile, setIsShowMobile] = useState(stockBalanceChangesFiltersInitialState.isShowMobile)
...
export default useStockBalanceChangesFilters
