...
interface UseCompanyAttributeOnChangeReturn {
...
// TODO: Move to l10n
const useCompanyAttributeOnChange = (): UseCompanyAttributeOnChangeReturn => {
...
export default useCompanyAttributeOnChange
