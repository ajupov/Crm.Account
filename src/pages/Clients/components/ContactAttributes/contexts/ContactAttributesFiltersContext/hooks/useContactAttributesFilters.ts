...
import ContactAttributesContext from '../../ContactAttributesContext/ContactAttributesContext'
...
// TODO: Move to l10n
const useContactAttributesFilters = (): ContactAttributesFiltersState => {
    ...
    const [isApplyEnabled, setIsApplyEnabled] = useState(contactAttributesFiltersInitialState.isApplyEnabled)
    const [isResetEnabled, setIsResetEnabled] = useState(contactAttributesFiltersInitialState.isResetEnabled)
    const [isShowMobile, setIsShowMobile] = useState(contactAttributesFiltersInitialState.isShowMobile)
...
export default useContactAttributesFilters
