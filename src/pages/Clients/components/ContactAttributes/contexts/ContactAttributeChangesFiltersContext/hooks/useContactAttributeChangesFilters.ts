...
import ContactAttributeChangesContext from '../../ContactAttributeChangesContext/ContactAttributeChangesContext'
import { FilterFormFieldProps } from '../../../../../../../components/common/forms/FilterForm/FilterForm'

// TODO: Move to l10n
const useContactAttributeChangesFilters = (): ContactAttributeChangesFiltersState => {
    ...
    const [isShowMobile, setIsShowMobile] = useState(contactAttributeChangesFiltersInitialState.isShowMobile)
...
export default useContactAttributeChangesFilters
