...
import OrderChangesContext from '../../OrderChangesContext/OrderChangesContext'

// TODO: Move to l10n
const useOrderChangesFilters = (): OrderChangesFiltersState => {
    ...
    const [isShowMobile, setIsShowMobile] = useState(orderChangesFiltersInitialState.isShowMobile)
...
export default useOrderChangesFilters
