...
import CustomerChangesContext from '../../CustomerChangesContext/CustomerChangesContext'
import { FilterFormFieldProps } from '../../../../../../components/common/forms/FilterForm/FilterForm'
import { InputOnChangeData } from 'semantic-ui-react'

// TODO: Move to l10n
const useCustomerChangesFilters = (): CustomerChangesFiltersState => {
    ...
    const [isShowMobile, setIsShowMobile] = useState(customerChangesFiltersInitialState.isShowMobile)
...
export default useCustomerChangesFilters
