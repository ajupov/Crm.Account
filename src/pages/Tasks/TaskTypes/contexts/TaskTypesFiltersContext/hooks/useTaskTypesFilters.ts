...
import TaskTypesContext from '../../TaskTypesContext/TaskTypesContext'
import { toBooleanNullable } from '../../../../../../utils/boolean/booleanUtils'

// TODO: Move to l10n
const useTaskTypesFilters = (): TaskTypesFiltersState => {
    ...
    const [isApplyEnabled, setIsApplyEnabled] = useState(taskTypesFiltersInitialState.isApplyEnabled)
    const [isResetEnabled, setIsResetEnabled] = useState(taskTypesFiltersInitialState.isResetEnabled)
    const [isShowMobile, setIsShowMobile] = useState(taskTypesFiltersInitialState.isShowMobile)
...
export default useTaskTypesFilters
