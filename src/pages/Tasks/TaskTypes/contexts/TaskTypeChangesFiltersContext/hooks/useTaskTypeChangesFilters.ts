...
import TaskTypeChangesContext from '../../TaskTypeChangesContext/TaskTypeChangesContext'

// TODO: Move to l10n
const useTaskTypeChangesFilters = (): TaskTypeChangesFiltersState => {
    ...
    const [isShowMobile, setIsShowMobile] = useState(taskTypeChangesFiltersInitialState.isShowMobile)
...
export default useTaskTypeChangesFilters
