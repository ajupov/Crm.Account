...
import TaskStatusesContext from '../../TaskStatusesContext/TaskStatusesContext'
import { toBooleanNullable } from '../../../../../../utils/boolean/booleanUtils'

// TODO: Move to l10n
const useTaskStatusesFilters = (): TaskStatusesFiltersState => {
    ...
    const [isApplyEnabled, setIsApplyEnabled] = useState(taskStatusesFiltersInitialState.isApplyEnabled)
    const [isResetEnabled, setIsResetEnabled] = useState(taskStatusesFiltersInitialState.isResetEnabled)
    const [isShowMobile, setIsShowMobile] = useState(taskStatusesFiltersInitialState.isShowMobile)
...
export default useTaskStatusesFilters
