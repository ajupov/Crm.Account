...
import TaskAttributesContext from '../../TaskAttributesContext/TaskAttributesContext'
...
// TODO: Move to l10n
const useTaskAttributesFilters = (): TaskAttributesFiltersState => {
    ...
    const [isApplyEnabled, setIsApplyEnabled] = useState(taskAttributesFiltersInitialState.isApplyEnabled)
    const [isResetEnabled, setIsResetEnabled] = useState(taskAttributesFiltersInitialState.isResetEnabled)
    const [isShowMobile, setIsShowMobile] = useState(taskAttributesFiltersInitialState.isShowMobile)
...
export default useTaskAttributesFilters
