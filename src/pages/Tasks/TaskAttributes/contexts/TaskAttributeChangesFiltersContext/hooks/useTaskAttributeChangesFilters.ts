...
import TaskAttributeChangesContext from '../../TaskAttributeChangesContext/TaskAttributeChangesContext'

// TODO: Move to l10n
const useTaskAttributeChangesFilters = (): TaskAttributeChangesFiltersState => {
    ...
    const [isShowMobile, setIsShowMobile] = useState(taskAttributeChangesFiltersInitialState.isShowMobile)
...
export default useTaskAttributeChangesFilters
