...
// TODO: Move to l10n
const useTaskAttributeOnChange = (): UseTaskAttributeOnChangeReturn => {
    ...
    const onChangeType = useCallback(
        (_, data: DropdownProps) => {
            state.setAttribute({ ...state.attribute, type: data.value as TaskAttributeType })
...
export default useTaskAttributeOnChange
