...
import SupplierChangesContext from '../../SupplierChangesContext/SupplierChangesContext'

// TODO: Move to l10n
const useSupplierChangesFilters = (): SupplierChangesFiltersState => {
    ...
    const [isShowMobile, setIsShowMobile] = useState(supplierChangesFiltersInitialState.isShowMobile)
...
export default useSupplierChangesFilters
