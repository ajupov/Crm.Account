...
interface UseSupplierAttributeOnChangeReturn {
...
// TODO: Move to l10n
const useSupplierAttributeOnChange = (): UseSupplierAttributeOnChangeReturn => {
    ...
    const onChangeType = useCallback(
        (_, data: DropdownProps) => {
            state.setAttribute({ ...state.attribute, type: data.value as SupplierAttributeType })
...
export default useSupplierAttributeOnChange
