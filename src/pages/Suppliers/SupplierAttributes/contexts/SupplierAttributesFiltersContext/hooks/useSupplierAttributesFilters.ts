...
import SupplierAttributesContext from '../../SupplierAttributesContext/SupplierAttributesContext'
...
// TODO: Move to l10n
const useSupplierAttributesFilters = (): SupplierAttributesFiltersState => {
    ...
    const [isApplyEnabled, setIsApplyEnabled] = useState(supplierAttributesFiltersInitialState.isApplyEnabled)
    const [isResetEnabled, setIsResetEnabled] = useState(supplierAttributesFiltersInitialState.isResetEnabled)
    const [isShowMobile, setIsShowMobile] = useState(supplierAttributesFiltersInitialState.isShowMobile)
...
export default useSupplierAttributesFilters
