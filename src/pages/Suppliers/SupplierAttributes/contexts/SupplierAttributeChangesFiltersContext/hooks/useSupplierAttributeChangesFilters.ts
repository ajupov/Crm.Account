...
import SupplierAttributeChangesContext from '../../SupplierAttributeChangesContext/SupplierAttributeChangesContext'

// TODO: Move to l10n
const useSupplierAttributeChangesFilters = (): SupplierAttributeChangesFiltersState => {
    ...
    const [isShowMobile, setIsShowMobile] = useState(supplierAttributeChangesFiltersInitialState.isShowMobile)
...
export default useSupplierAttributeChangesFilters
