...
import ProductCategoryCreate from '../../pages/products/categories/Create/ProductCategoryCreate'
import ProductCategoryEdit from '../../pages/products/categories/Edit/ProductCategoryEdit'
import ProductCategoryView from '../../pages/products/categories/View/ProductCategoryView'
