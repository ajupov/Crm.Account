...
export default class LeadsClient {
    ...
    public GetAsync = (id: string): Promise<Lead> =>
        this.httpClientFactory.createClient(this.httpClientFactory.host).get<Lead>('/Leads/v1/Get', { id })

    public GetListAsync = (values?: string[]): Promise<Lead[]> =>
        this.httpClientFactory.createClient(this.httpClientFactory.host).post<Lead[]>('/Leads/v1/GetList', values)
    ...
    public CreateAsync = (lead?: Lead): Promise<string> =>
        this.httpClientFactory.createClient(this.httpClientFactory.host).put<string>('/Leads/v1/Create', lead)

    public UpdateAsync = (lead?: Lead): Promise<void> =>
        this.httpClientFactory.createClient(this.httpClientFactory.host).patch('/Leads/v1/Update', lead)

    public DeleteAsync = (values?: string[]): Promise<void> =>
        this.httpClientFactory.createClient(this.httpClientFactory.host).patch('/Leads/v1/Delete', values)

    public RestoreAsync = (values?: string[]): Promise<void> =>
        this.httpClientFactory.createClient(this.httpClientFactory.host).patch('/Leads/v1/Restore', values)
}
